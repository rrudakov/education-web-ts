        ...
        <Card>
          ...
          <CardContent>
            ...
            >
              ...
              может быть: развитие речи, музыка, окружающий мир. В каждом уроке
              я обязательно использую различные гимнастики (пальчиковая,
              ...
              плодотворно сказывается на развитии мозга (ведь известно, что
              отдел мозга, отвечающий за движения и отдел, отвечающий за речь,
              расположены рядом).
            </Typography>
            <Typography
              paragraph
              ...
              color="textSecondary"
            >
              На уроках я также использую артикуляционную гимнастику, что
              помогает в постановке звуков. Мы поем песенки, отгадываем загадки,
              выполняем упражнения на логику и мышление, играем в разные игры и
              просто учимся разговаривать и общаться. Уроки проводятся на разных
              ...
              подходит ли вам такой формат занятий. Ну и конечно, если вы живете
              в Нидерландах, у вас всегда есть возможность придти ко мне на урок
