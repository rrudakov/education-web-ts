...
export const UPDATE_CERTIFICATES_MODAL_OPEN = "UPDATE_CERTIFICATES_MODAL_OPEN/HOME";
...
export type HomeActionTypes = UpdateMainFeaturedAction | UpdateFeaturedAction | UpdateFullPostsAction | UpdateCertificatesModalOpenAction;
