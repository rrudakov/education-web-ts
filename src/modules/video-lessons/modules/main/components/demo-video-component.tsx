  ...
  return (
    <Grow in={videoLoaded}>
      <Card className={classes.root}>
        <CardMedia
          component="video"
          src="https://alenkinaskazka.nl/media/video_2020-10-27_08-55-05.webm"
          controls
          title="Demo video"
          poster={DemoPoster}
        ...
        <CardContent>
          ...
          >
            ...
            уроков, а именно видео-уроки про фермера Ваню, которые уже
            полюбились моим ученикам, с которыми я уже занимаюсь. Каждый урок
          ...
          <Collapse in={expanded} timeout="auto" unmountOnExit>
            <List>
              <BulletListItem>
                ...
                ребенка и делает урок нескучным. Малышам очень нравится следить
                за персонажами и слова легко запоминаются.
              </BulletListItem>
              <BulletListItem>
              ...
              <BulletListItem>
                ...
                особых приготовлений, а впечатления и у вас и у ребенка
                останутся надолго!!!
              </BulletListItem>
            </List>
            ...
            <List>
              ...
              <BulletListItem>
                Если вы также являетесь педагогом и работаете в сфере
                дошкольного образования, то для вас есть множество упражнений,
                которые вы сможете использовать на своих уроках, большинство
                которых моего авторства.
              </BulletListItem>
              <BulletListItem>
